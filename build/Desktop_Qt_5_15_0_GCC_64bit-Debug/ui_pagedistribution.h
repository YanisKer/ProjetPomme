...
public:
    ...
    void setupUi(QWidget *pagedistribution)
    {
        ...
        fr_pompe_1->setGeometry(QRect(20, 110, 141, 131));
        ...
        fr_pompe_2->setGeometry(QRect(180, 110, 141, 131));
        ...
        fr_pompe_4 = new QFrame(pagedistribution);
        fr_pompe_4->setObjectName(QString::fromUtf8("fr_pompe_4"));
        fr_pompe_4->setGeometry(QRect(500, 110, 131, 131));
        fr_pompe_4->setFrameShape(QFrame::StyledPanel);
        fr_pompe_4->setFrameShadow(QFrame::Raised);
        label_4 = new QLabel(fr_pompe_4);
        ...
        fr_pompe_3->setGeometry(QRect(340, 110, 141, 131));
        QFont font2;
        ...
        fr_pompe_5 = new QFrame(pagedistribution);
        fr_pompe_5->setObjectName(QString::fromUtf8("fr_pompe_5"));
        fr_pompe_5->setGeometry(QRect(650, 110, 131, 131));
        fr_pompe_5->setFrameShape(QFrame::StyledPanel);
        fr_pompe_5->setFrameShadow(QFrame::Raised);
        label_6 = new QLabel(fr_pompe_5);
