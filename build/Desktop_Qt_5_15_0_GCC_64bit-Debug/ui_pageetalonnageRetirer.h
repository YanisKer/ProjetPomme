/********************************************************************************
** Form generated from reading UI file 'pageetalonnageRetirer.ui'
**
...
#ifndef UI_PAGEETALONNAGERETIRER_H
#define UI_PAGEETALONNAGERETIRER_H
...
public:
    ...
    void setupUi(QWidget *pageetalonnage)
    {
        ...
        label_2->setGeometry(QRect(190, 220, 741, 41));
        QFont font2;
    ...
    void retranslateUi(QWidget *pageetalonnage)
    {
        ...
        label_2->setText(QCoreApplication::translate("pageetalonnage", "Retirer la bouteille de la pince, merci.", nullptr));
    } // retranslateUi
...
#endif // UI_PAGEETALONNAGERETIRER_H
